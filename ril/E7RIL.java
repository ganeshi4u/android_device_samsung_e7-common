...
/**
 * RIL customization for Samsung E7 devices
 *
 * {@hide}
 */
public class E7RIL extends RIL implements CommandsInterface {
    ...
    public E7RIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
